...
- `sast-only` -> `canonical-v2-static-aa42fb43-5c83-482c-a354-6ba52f687f4a` (13 package/version units, 81 rows)
- `profile:budget:llm-no-agentic` -> `canonical-v2-budget-1459a5c3-0dd6-4b47-8027-40f58d759034` (13 package/version units, 648 rows)
- `profile:medium:llm-no-agentic` -> `canonical-v2-medium-f129dbec-47af-47a7-b037-8be8c1a2c958` (13 package/version units, 648 rows)
- `profile:frontier:llm-no-agentic` -> `canonical-v2-frontier-82ee1e93-edc0-47af-9e63-380d2422c95a` (13 package/version units, 810 rows)
- `profile:frontier:agentic-only` -> `canonical-v2-frontier-agentic-75d9db82-0437-4d0d-a53a-6ca9d8a74142` (11 package/version units, 37 rows)
- `profile:all_models:identity-alias-probe` -> `canonical-v2-alias-83d6c7de-2aa3-49fb-a097-a717183120df` (13 package/version units, 351 rows)
...
- Cleaned lost detections under alias masking: 10

## Repair Comparison

- Total corrected source error rows compared: 0
- Corrected to non-error: 0
